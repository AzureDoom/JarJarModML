 ...
 * <pre>{@code
 *
 * public static final Supplier<EntityType<TestEntity>> TEST = CommonEntityRegistryInterface.registerEntity(
 *     "modid",
 *     "entityname",
 *     TestEntity::new,
 ...
 * </p>
 * <ul>
 * <li><code>registerEntity</code> is a method to register a new entity with the specified mod ID, entity name, factory
 ...
 * <li><code>0x1F1F1F</code> and <code>0x0D0D0D</code> represent the primary and secondary colors of the entity's spawn
 * egg.</li>
 * </ul>
 * <p>
...
public interface CommonEntityRegistryInterface {
    ...
    static <T extends Entity> Supplier<EntityType<T>> registerEntity(
        ...
        return Services.COMMON_REGISTRY.registerEntity(
            modID,
            entityName,
