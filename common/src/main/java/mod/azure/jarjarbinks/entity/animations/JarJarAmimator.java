...
public class JarJarAmimator extends AzEntityAnimator<JarJarBinksEntity> {
    ...
    @Override
    public void registerControllers(AzAnimationControllerContainer<JarJarBinksEntity> animationControllerContainer) {
    ...
    @Override
    public @NotNull ResourceLocation getAnimationLocation(JarJarBinksEntity animatable) {
        return animationLocation;
    }

    @Override
    public void setCustomAnimations(JarJarBinksEntity animatable, float partialTicks) {
